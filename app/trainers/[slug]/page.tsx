...
export async function generateMetadata({ params }: { params: { slug: string } }): Promise<Metadata> {
  ...
  const title = `${decodeHtmlEntities(trainer.title.rendered)} | Unika Fitness Club`
  const description = `Scopri di più su ${decodeHtmlEntities(trainer.title.rendered)}, ${trainer.acf.role} presso Unika Fitness Club.`
  const canonicalUrl = `/trainers/${trainer.slug}`

  return {
    title,
    description,
    keywords: [
      trainer.title.rendered.toLowerCase(),
      trainer.acf.role.toLowerCase(),
      "personal trainer",
      "fitness",
      "Roma",
    ],
    ...
    openGraph: {
      ...
      images: [
        {
          url: trainer.featured_image_url,
          width: 1200,
          height: 630,
          alt: title,
        },
    ...
    twitter: {
      ...
      title,
      description,
      images: [trainer.featured_image_url],
    },
  }
}
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <TextReveal delay={0.2}>
                <StaticContent content={trainer.content.rendered} className="text-lg text-gray-600 mb-8" />
              </TextReveal>

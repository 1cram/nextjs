...
export const metadata: Metadata = {
  title: "TRX | Unika Fitness Club",
  description:
    "Corso di TRX Suspension Training. Allenamento funzionale con le cinghie per sviluppare forza, equilibrio e flessibilità.",
  keywords: ["TRX", "suspension training", "allenamento sospensione", "forza", "equilibrio", "Roma"],
}
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-20 px-4 bg-[#f5f5f7]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <TextReveal>
                <h1 className="text-4xl md:text-5xl font-bold mb-2">TRX Suspension Training</h1>
              </TextReveal>
              <TextReveal delay={0.1}>
                <div className="flex flex-wrap gap-4 my-6">
                  ...
                  <div className="flex items-center bg-gray-200 text-gray-700 px-3 py-1 rounded-full text-sm">
                    <span>Calorie: 350-450 kcal</span>
                  </div>
                </div>
              </TextReveal>
              <TextReveal delay={0.2}>
                <p className="text-lg text-gray-600 mb-8">
                  Il TRX Suspension Training utilizza il peso corporeo e la gravità per sviluppare forza, equilibrio,
                  flessibilità e stabilità del core simultaneamente. Un allenamento completo con un solo attrezzo.
                </p>
              </TextReveal>
            ...
            <div className="relative h-[400px] rounded-2xl overflow-hidden">
              <Image
                src="/placeholder.svg?height=800&width=800&text=TRX Training"
                alt="TRX Suspension Training"
                fill
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="md:col-span-2">
              ...
              <div className="prose prose-lg max-w-none">
                <p>
                  Il TRX Suspension Training è un sistema di allenamento rivoluzionario che utilizza cinghie di
                  sospensione per sfruttare il peso corporeo e la gravità come resistenza. Nato dall'addestramento
                  militare, è ora utilizzato da atleti professionisti e appassionati di fitness in tutto il mondo.
                </p>
                <p>
                  Durante le lezioni imparerai centinaia di esercizi che possono essere facilmente modificati per
                  adattarsi al tuo livello di fitness. Dalla riabilitazione all'allenamento ad alta intensità, il TRX
                  offre infinite possibilità.
                </p>
                <p>
                  Ogni lezione include un riscaldamento dinamico, esercizi di forza e resistenza, lavoro sul core e
                  stretching finale. Gli esercizi coinvolgono tutto il corpo, migliorando forza, equilibrio,
                ...
                <ul className="space-y-4">
                  <FadeInSection direction="right" delay={0.1}>
                    <li className="flex items-start">
                      ...
                      <span className="text-lg">Sviluppa forza funzionale</span>
                    </li>
                  </FadeInSection>
                  <FadeInSection direction="right" delay={0.2}>
                    <li className="flex items-start">
                      <span className="inline-block w-5 h-5 rounded-full bg-unika-yellow mr-3 flex-shrink-0 mt-1"></span>
                      <span className="text-lg">Migliora l'equilibrio</span>
                    </li>
                  </FadeInSection>
                  <FadeInSection direction="right" delay={0.3}>
                    <li className="flex items-start">
                      <span className="inline-block w-5 h-5 rounded-full bg-unika-yellow mr-3 flex-shrink-0 mt-1"></span>
                      <span className="text-lg">Aumenta la flessibilità</span>
                    </li>
                  </FadeInSection>
                  <FadeInSection direction="right" delay={0.4}>
                    <li className="flex items-start">
                      <span className="inline-block w-5 h-5 rounded-full bg-unika-yellow mr-3 flex-shrink-0 mt-1"></span>
                      <span className="text-lg">Rinforza il core</span>
                    </li>
                  </FadeInSection>
                ...
                <ul className="space-y-4">
                  <FadeInSection direction="right" delay={0.1}>
                    <li className="flex items-start">
                      ...
                      <span className="text-lg">Lunedì: 19:30 - 20:15</span>
                    </li>
                  </FadeInSection>
                  <FadeInSection direction="right" delay={0.2}>
                    <li className="flex items-start">
                      <Calendar className="w-5 h-5 text-unika-yellow mr-3 flex-shrink-0 mt-1" />
                      <span className="text-lg">Mercoledì: 18:00 - 18:45</span>
                    </li>
                  </FadeInSection>
                  <FadeInSection direction="right" delay={0.3}>
                    <li className="flex items-start">
                      <Calendar className="w-5 h-5 text-unika-yellow mr-3 flex-shrink-0 mt-1" />
                      <span className="text-lg">Venerdì: 19:00 - 19:45</span>
                    </li>
                  </FadeInSection>
                </ul>
              </div>
      ...
      <section className="py-20 px-4 bg-black text-white">
        <div className="max-w-5xl mx-auto text-center">
          <TextReveal>
            <h2 className="text-4xl font-semibold mb-4">Pronto a provare il TRX?</h2>
            <p className="text-xl mb-8 max-w-3xl mx-auto">
              Scopri la potenza dell'allenamento in sospensione e trasforma il tuo corpo.
            </p>
            <Link href="/prenota">

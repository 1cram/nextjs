...
export const metadata: Metadata = {
  title: "Fitness Funzionale | Unika Fitness Club",
  description:
    "Corso di Fitness Funzionale per migliorare forza, mobilità e coordinazione attraverso movimenti naturali del corpo.",
  keywords: ["fitness funzionale", "allenamento funzionale", "forza", "mobilità", "Roma"],
}

export default function FitnessFunzionalePage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-20 px-4 bg-[#f5f5f7]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <TextReveal>
                <h1 className="text-4xl md:text-5xl font-bold mb-2">Fitness Funzionale</h1>
              </TextReveal>
              <TextReveal delay={0.1}>
                <div className="flex flex-wrap gap-4 my-6">
                  ...
                  <div className="flex items-center bg-gray-200 text-gray-700 px-3 py-1 rounded-full text-sm">
                    <span>Calorie: 400-500 kcal</span>
                  </div>
                </div>
              </TextReveal>
              <TextReveal delay={0.2}>
                <p className="text-lg text-gray-600 mb-8">
                  Il Fitness Funzionale si basa su movimenti naturali del corpo umano, migliorando forza, mobilità,
                  coordinazione e stabilità attraverso esercizi che riproducono i gesti della vita quotidiana.
                </p>
              </TextReveal>
            ...
            <div className="relative h-[400px] rounded-2xl overflow-hidden">
              <Image
                src="/placeholder.svg?height=800&width=800&text=Fitness Funzionale"
                alt="Fitness Funzionale"
                fill
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="md:col-span-2">
              ...
              <div className="prose prose-lg max-w-none">
                <p>
                  Il Fitness Funzionale è un metodo di allenamento che si concentra sui movimenti naturali del corpo,
                  utilizzando esercizi multi-articolari che coinvolgono più gruppi muscolari contemporaneamente.
                </p>
                <p>
                  Durante le lezioni utilizziamo attrezzi come kettlebell, medicine ball, TRX, corde navali e il peso
                  corporeo per creare allenamenti dinamici e coinvolgenti. Ogni esercizio è progettato per migliorare la
                  tua capacità di muoverti in modo efficiente nella vita quotidiana.
                </p>
                <p>
                  Il corso è strutturato con un riscaldamento dinamico, una fase di allenamento principale con circuiti
                  ad alta intensità e una fase di defaticamento con stretching e mobilità.
                </p>
              </div>
            </div>
            <div>
                ...
                <ul className="space-y-4">
                  <FadeInSection direction="right" delay={0.1}>
                    <li className="flex items-start">
                      ...
                      <span className="text-lg">Migliora la forza funzionale</span>
                    </li>
                  </FadeInSection>
                  ...
                  <FadeInSection direction="right" delay={0.3}>
                    <li className="flex items-start">
                      <span className="inline-block w-5 h-5 rounded-full bg-unika-yellow mr-3 flex-shrink-0 mt-1"></span>
                      <span className="text-lg">Migliora la stabilità del core</span>
                    </li>
                  </FadeInSection>
                  ...
                  <FadeInSection direction="right" delay={0.5}>
                    <li className="flex items-start">
                      <span className="inline-block w-5 h-5 rounded-full bg-unika-yellow mr-3 flex-shrink-0 mt-1"></span>
                      <span className="text-lg">Previene gli infortuni</span>
                    </li>
                  </FadeInSection>
                </ul>
              </div>
              ...
              <div className="bg-[#f5f5f7] rounded-2xl p-8">
                <ul className="space-y-4">
                  ...
                  <FadeInSection direction="right" delay={0.2}>
                    <li className="flex items-start">
                      <Calendar className="w-5 h-5 text-unika-yellow mr-3 flex-shrink-0 mt-1" />
                      <span className="text-lg">Giovedì: 18:30 - 19:20</span>
                    </li>
                  </FadeInSection>
                  <FadeInSection direction="right" delay={0.3}>
                    <li className="flex items-start">
                      <Calendar className="w-5 h-5 text-unika-yellow mr-3 flex-shrink-0 mt-1" />
                      <span className="text-lg">Sabato: 10:00 - 10:50</span>
                    </li>
                  </FadeInSection>
                </ul>
              </div>
      ...
      <section className="py-20 px-4 bg-black text-white">
        <div className="max-w-5xl mx-auto text-center">
          <TextReveal>
            <h2 className="text-4xl font-semibold mb-4">Pronto a iniziare con il Fitness Funzionale?</h2>
            <p className="text-xl mb-8 max-w-3xl mx-auto">
              Prenota una lezione oggi stesso e scopri come migliorare la tua forza funzionale.
            </p>
            <Link href="/prenota">

...
import { formatDate, getSafeImageUrl, decodeHtmlEntities } from "@/lib/api-helpers"
  ...
  useEffect(() => {
    const fetchRelatedPosts = async () => {
      try {
        ...
        const filtered = allPosts.filter((p: BlogPost) => p.id !== post.id).slice(0, 3)

...
export default function MainNavbar({
  ...
  const navItems: NavItem[] = [
    ...
    { label: "CORSI", href: "/corsi" }, // Updated to point to dedicated courses page instead of homepage section
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  {["Pilates", "EMS", "Orari", "Corsi", "Personal Training"].map((term, index) => (
                    <Button
                      key={index}
                      variant="outline"
                      className="border-gray-600 text-white hover:bg-unika-dark-lighter bg-transparent"
                      onClick={() => {
                        setSearchQuery(term)
                      }}
                    >
